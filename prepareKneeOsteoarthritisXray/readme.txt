...
-create folder named "all_data"
-copy and paste "template_empty_folder" twice and rename to "selected_data" and "selected_processed_data"
...
-replace "selected_data" and "selected_processed_data" with "template_empty_folder" and rename both again
